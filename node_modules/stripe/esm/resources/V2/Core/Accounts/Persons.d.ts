...
export declare class PersonResource extends StripeResource {
     ...
     */
    list(id: string, params?: V2.Core.Accounts.PersonListParams, options?: RequestOptions): V2ListPromise<AccountPerson>;
    /**
     ...
     * @throws Stripe.RateLimitError
     */
    create(id: string, params?: V2.Core.Accounts.PersonCreateParams, options?: RequestOptions): Promise<Response<AccountPerson>>;
    /**
